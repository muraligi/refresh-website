    ...
    <div>
      <div className="story-full-page">
        <div className="storytop-row">
          <img
            className="leftstyimg"
            src={require("../../images/StoryImages/Storyimg-lefttop.png")}
          />
          <img
            className="rightstyimg"
            src={require("../../images/StoryImages/Storyimg-righttop.png")}
          />
        </div>
        ...
        <div className="Man-row">
          <img
            id="man-img"
            src={require("../../images/StoryImages/manimg.png")}
          />
          <div className="white-space-conman">
            ...
            <p>
              ...
              best largest and most premium brands in the world (e.g. Tom Ford,
              Lab Series, etc.).
            </p>
            <p>
              We teamed up to create a world-class offering of men's products
              leveraging the experience and personal lessons we've learned along
              the way.
            </p>
            <p>
              We're excited that you're here and hope that you'll join along for
              the ride.
            </p>
          </div>
        </div>
        ...
        <div className="develop-page">
          <h1>
            We’ve taken our passion and developed A+ personal care products for
            guys everywhere.
          </h1>
        ...
        <div className="Man-row">
          <img
            id="nature-img"
            src={require("../../images/StoryImages/greamnat.png")}
          />
          <div className="white-space-connat">
            <h1>Ingredients with integrity.</h1>
            <p>
              We only use the best, most effective ingredients. Our products are
              100% vegan, certified cruelty-free, and free of parabens,
        ...
        <div id="pro-row">
          <div className="white-space-pro">
            ...
            <p>
              Our packaging materials are 100% recyclable, and our products are
              made right here in the USA, eliminating unnecessary transport
              emissions.
            </p>
          </div>
          <img
            id="pro-img"
            src={require("../../images/StoryImages/productboximg.png")}
          />
        </div>

        <div className="storybot-row">
          <img
            className="leftbotimg"
            src={require("../../images/StoryImages/Storyimg-leftbot.png")}
          />
          <img
            className="rightbotimg"
            src={require("../../images/StoryImages/Storyimg-rightbot.png")}
          />
        </div>
